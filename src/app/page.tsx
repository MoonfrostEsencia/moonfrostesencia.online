...
<h2 className="text-4xl md:text-6xl  bg-clip-text text-transparent bg-gradient-to-b from-blue-100 mb-16 to-neutral-600 font-sans font-bold">Enter the Enchantment of Moonfrost Esencia!
                </h2>
...
<h2 className="text-4xl md:text-6xl font-bold dark:text-white font-sans font-bold">Discover Why Choose Us:
                </h2>
</div>
       <Approach></Approach>
...
<h2 className="text-4xl md:text-6xl  bg-clip-text text-transparent bg-gradient-to-b from-white mb-8 to-neutral-600 font-sans font-bold">Testimonials✨
                </h2>
</div>
      <Clients></Clients>
      </section>
