  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-5 bg-gradient-to-br from-yellow-200 to-blue-300 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
      Ignite Your Future
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-neutral-300 via-transparent to-transparent text-blue-500></text-blue-500> [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-neutral-300 text-blue-500 [--conic-position:from_290deg_at_center_top]"
        >
