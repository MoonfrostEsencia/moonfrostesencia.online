...
import TestimonialImage01 from './p1.png'
import TestimonialImage02 from './p1.png'
import TestimonialImage03 from './p1.png'
import "./globals.css";
      ...
      <div className="testimonials max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-blue-900">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-black">Vitae aliquet nec ullamcorper sit amet risus nullam eget felis semper quis lectus nulla at volutpat diam ut venenatis tellus—in ornare.</p>
          </div>
