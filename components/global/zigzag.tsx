...
import FeatImage01 from './p4.png'
import FeatImage02 from './p4.png'
import FeatImage03 from './p4.png'

export default function Zigzag() {
  return (
    <section>
      <div className="testimonials max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-blue-900">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-xl text-black mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <div className="absolute left-0 bottom-100 -ml-20 hidden lg:block pointer-events-none" aria-hidden="true" data-aos="fade-up" data-aos-delay="400">
          <svg className="max-w-full" width="399" height="699" viewBox="0 0 564 552" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="illustration-02" x1="-3.766" y1="300.204" x2="284.352" y2="577.921" gradientUnits="userSpaceOnUse">
                <stop stopColor=",#00CCCC" stopOpacity=".01" />
                <stop offset="1" stopColor="#006633" stopOpacity=".32" />
              </linearGradient>
            </defs>
