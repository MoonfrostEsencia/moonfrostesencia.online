...
export const Hero = () => {
  return (
    <div className="pb-20 pt-9">
      ...
      <div className="absolute left-0 top-0 flex h-10px w-full items-center justify-center bg-white bg-grid-black/[0.2] dark:bg-black dark:bg-grid-white/[0.03]">
      ...
      <div className="relative z-10 my-20 flex justify-center">
        <div className="flex max-w-[89vw] flex-col items-center justify-center md:max-w-2xl lg:max-w-[60vw]">
          ...
          <TextGenerateEffect
            ...
            words="Elevate Your Brand: Discover Our Comprehensive Services"
          />
