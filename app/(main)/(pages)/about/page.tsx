...
import { VortexDemo } from "@/components/global/vortex2";
...
import { GoogleGeminiEffectDemo } from "@/components/global/google-gemini-effect2";
import { TypewriterEffectSmoothDemo } from "@/components/global/typewriter-effect2";
...
<Hero></Hero>
          <TextRevealCardPreview></TextRevealCardPreview>
              ...
              <div className="flex items-center p-4 mt-[-100px] flex-col">
                  ...
                  >
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-neutral-500 to-neutral-600  md:text-center font-sans group-hover:bg-gradient-to-r group-hover:from-black justify-center goup-hover:to-black">
